...
/**
 * The authority to make one new held value from three existing ones, of different types.
 *
 * <p>Arity is part of the type, so a three-parent derivation cannot be handed the wrong number of
