...
public record Manifest(
    String bottom, List<Entry> destinations, List<Entry> derivations, List<Entry> checks) {
  ...
  /** The operations that can weaken a label: the ones a reviewer is actually looking for. */
