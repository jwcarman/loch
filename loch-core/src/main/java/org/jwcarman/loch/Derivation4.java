...
/**
 * The authority to make one new held value from four existing ones, of different types.
 *
 * <p>Arity is part of the type, so a four-parent derivation cannot be handed the wrong number of
 ...
 * handed one.
 */
public interface Derivation4<I1, I2, I3, I4, O> {

  /** Makes the new value, or refuses. */
  Derived<O> derive(Handle<I1> first, Handle<I2> second, Handle<I3> third, Handle<I4> fourth);
